...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Ops',
    nsPrefix: 'Milpa\\Ops\\',
    installCommand: 'composer require milpa/ops',
    repoUrl: 'https://github.com/getmilpa/ops',
    pagesUrl: 'https://getmilpa.github.io/ops/',
    heroParagraph: 'The Milpa system\'s metabolism: security scanning, backup/restore, scheduled maintenance and bootstrap — the operations any Milpa app gets for free. Domain-blind and zero-Doctrine (ADR-0023).',
    utmContent: 'ops',
);
